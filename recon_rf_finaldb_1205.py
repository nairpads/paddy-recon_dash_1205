...
if mt_file and ledger_file and model_file:
    ...
    # ✅ Fixed DC column logic based on your uploaded file
    dc_mt_col = 'dr_cr_mt'
    dc_ld_col = 'dr_cr_ld'
    ...
    # Optional: display DC matching for verification
    st.write("Sample DC Combinations:", pairs_df[[dc_mt_col, dc_ld_col, 'dc_mirror']].drop_duplicates())
